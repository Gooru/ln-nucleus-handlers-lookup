...
class MessageProcessor implements Processor {
        ...
        try {
            ...
            default:
                ...
                return MessageResponseFactory
                    .createInvalidRequestResponse(RESOURCE_BUNDLE.getString("invalid.item.lookup"));
            }
            return result;
        } catch (Throwable e) {
    ...
    private MessageResponse processSchoolDistricts() {
        getRequestParam();
        return RepoBuilder.buildSchoolDistrictsRepo().getSchoolDistricts(this.keyword, this.stateId, this.limit,
            this.offset);
    }
