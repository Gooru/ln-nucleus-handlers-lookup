...
public class AJEntityMetadataReference extends Model {
	...
	public static final List<String> FETCH_FIELDS = Arrays.asList("id",
			"label", "sequence_id");
	public static final List<String> FETCH_LICENSE_FIELDS = Arrays.asList("id",
			"label", "info", "sequence_id");

	public static final String FETCH_METADATA_QUERY = "select id, label, sequence_id from metadata_reference where format = ?::metadata_reference_type and is_visible = true order by sequence_id";

	public static final String FETCH_METADATA_LICENSE_QUERY = "select id, label, info, sequence_id from metadata_reference where format = ?::metadata_reference_type and is_visible = true order by "
			+ "sequence_id";
