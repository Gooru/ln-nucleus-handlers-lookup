...
public final class DBHandlerBuilder {
  ...
  public static DBHandler fetchRowlistExecutorHandlerBuilder(String name, String sql,
      List<String> fieldsInJson) {
    return new FetchRowlistExecutorHandler(name, sql, fieldsInJson);
  }

  public static DBHandler schoolHandlerBuilder(String keyword, String schoolDistrictId, int limit,
      int offset) {
    return new SchoolHandler(keyword, schoolDistrictId, limit, offset);
  }

  public static DBHandler schoolDistrictHandlerBuilder(String keyword, String stateId, int limit,
      int offset) {
